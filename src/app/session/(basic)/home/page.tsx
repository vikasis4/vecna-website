import UpcomingEventsCard from "@/modules/basic/home/components/EventsCard";
import RecentProjectsCard from "@/modules/basic/home/components/RecentProjectsCard";
  ...
  return (
    <main className="h-full w-full">
      <header className="h-full w-full flex flex-col gap-16 justify-center items-center">
        <h1 className="text-5xl mt-12 font-bold font-sans">
          Hello There! Vikas
        </h1>
